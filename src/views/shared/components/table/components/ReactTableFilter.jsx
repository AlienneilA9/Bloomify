...
const ReactTableFilter = ({ rows, setGlobalFilter, setFilterValue, placeholder, dataLength }) => {
    ...
    return (
        <div className="table__search">
            <Input className="table__search table__search-input" onChange={e => onChange(e.target.value)} placeholder={`${placeholder}`} />
