...
const SellBTC = ({ onSubmit }) => (
    <div className="dashboard__place-order-form">
        <h5 className="bold-text textheight">SELL $NCTR</h5>
                ...
                <form className="form form--horizontal" onSubmit={handleSubmit}>
                    <div className="form__form-group12">
                        ...
                        <div className="form__form-group-field1">
                            <Field name="price" component="input" type="text" placeholder="$NCTR" className="input12" />
                    ...
                    <div className="form__form-group">
                        ...
                        <div className="form__form-group-field">
                            <Field name="amount" component="input" type="text" placeholder="$USDC.e" className="input12 makeRadius" />
                        </div>
                    </div>
                    <div>
