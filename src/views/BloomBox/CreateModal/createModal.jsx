            ...
            <div className="modalBackground">
                <div className="modalContainer">
                    <div className="modalTitle">
                        {" "}
                        <p>Create Flower</p> <button onClick={() => closeModal(false)}> X </button>
                    </div>
                    <div className="modalBody">
                        ...
                        <div className="setFlex modalFlex">
                            <div className="modalTitle">
                                ...
                                <label className="labelname setLeft">Available: 15 $NCTR </label>
                            </div>
                            <div className="setFlex1 sto">
                                <input className="getDownlineWallet osm input1" type="number" name="name" />
                                <input className="getDownlineWallet dvs maxHeight" type="submit" value="Max" />
                            </div>
                        </div>
                    </div>
